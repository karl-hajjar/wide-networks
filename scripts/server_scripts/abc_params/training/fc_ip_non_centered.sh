...
#SBATCH --job-name=karl-ip-non-centered
...
srun -N1 --nodelist=node[11] python3 pytorch/jobs/abc_parameterizations/fc_ip_non_centered_run.py --activation=$1 --dataset=$2 --n_steps=$3
