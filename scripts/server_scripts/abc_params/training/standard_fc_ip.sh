...
#SBATCH --job-name=karl-std-fc-ip
...
# -- Contexte matériel
#SBATCH --nodes=1 --nodelist=node14
...
srun -N1 python3 pytorch/jobs/abc_parameterizations/standard_fc_ip_run.py --activation=$1 --dataset=$2 --n_steps=$3
