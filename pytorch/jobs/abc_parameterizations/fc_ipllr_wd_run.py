...
@click.option('--weight_decay', '-wd', required=False, type=click.FLOAT, default=0.01,
              help='Strength of the weight decay')
...
def run(activation="relu", n_steps=300, base_lr=0.01, weight_decay=0.01, batch_size=512, dataset="mnist",
        download=False):
